...
const multisigPrivateKey = 'F97768CDEE39045D2AA9177F7496718C90F00E7B71B55134DCE7915EFE65E691';
...
const guarantorAccount = Account.createFromPrivateKey(alicePrivateKey, NetworkType.MIJIN_TEST);

console.log(aliceAccount.publicKey)
console.log(ticketDistributorAccount.publicKey)
console.log(multisigAccount.publicKey)
console.log(guarantorAccount.publicKey)

const xemTx = TransferTransaction.create(
    Deadline.create(),
...
const ticketTx = TransferTransaction.create(
    Deadline.create(),
    Account.generateNewAccount(NetworkType.MIJIN_TEST).address,
...
const aggregateTransaction = AggregateTransaction.createBonded(Deadline.create(),
    [
        xemTx.toAggregate(multisigAccount.publicAccount),
        ticketTx.toAggregate(multisigAccount.publicAccount),
    ],
    NetworkType.MIJIN_TEST);
