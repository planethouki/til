...
const recipientAddress = 'SBWEUWON6IBHCW5IC4EI6V6SMTVJGCJWGLF57UGK';
const multisigTeamPublicKey = '86483CAF5AA77935A4C59201A1B0C0B3FD5EAF12EC78A8221D7BEF3ABB4F9B29';
const member1PrivateKey = '7808B5B53ECF24E40BE17B8EC3D0EB5F7C3F3D938E0D95A415F855AD4C27B2A4';

const multisigAccount = PublicAccount.createFromPublicKey(multisigTeamPublicKey, NetworkType.MIJIN_TEST);
const member1Account = Account.createFromPrivateKey(member1PrivateKey, NetworkType.MIJIN_TEST);
...
const signedTransaction = member1Account.sign(aggregateTransaction);
...
const lockFundsTransactionSigned = member1Account.sign(lockFundsTransaction);

console.log('lockFundsTx.hash   : ' + lockFundsTransactionSigned.hash);
console.log('lockFundsTx.signer : ' + lockFundsTransactionSigned.signer);
console.log('aggregateTx.hash   : ' + signedTransaction.hash);
console.log('aggregateTx.signer : ' + signedTransaction.signer);
